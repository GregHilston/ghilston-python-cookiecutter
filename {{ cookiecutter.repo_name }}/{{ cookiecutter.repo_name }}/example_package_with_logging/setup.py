...
from example_package_with_logging import __version__
...
setup(
    ...
    url="https://github.com/GregHilston/ghilston-python-cookiecutter/tree/master/%7B%7B%20cookiecutter.repo_name%20%7D%7D/example_package_with_logging",
    entry_points={
